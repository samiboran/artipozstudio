...
const PAGE_TEXT_FIELDS = {
  gallery: [
    ...
    { section: 'hizmet-fine-art-aciklama', label: 'Hizmetlerimiz — Fine Art / Giclée Baskı Kart Açıklaması', placeholder: 'Fine art baskı hizmetimizle, arşivlik pigment mürekkepler ve özel sanat kağıtları kullanarak eserlerinizi yüksek kalite, doğru renk ve uzun ömürle sunuyoruz.', tall: true },
    ...
    { section: 'hizmet-edisyon-aciklama', label: 'Hizmetlerimiz — Edisyon & Art Print Üretimi Kart Açıklaması', placeholder: 'Sanatçılar için sınırlı sayıda edisyon üretimi, numaralandırma, imza ve sertifika desteğiyle özgün baskı süreçlerini yönetiyoruz.', tall: true },
    ...
    { section: 'hizmet-poster-aciklama', label: 'Hizmetlerimiz — Poster & Kartpostal Baskı Kart Açıklaması', placeholder: 'Poster, kartpostal ve küçük format baskılarınız için yüksek kaliteli, uygun fiyatlı ve hızlı üretim çözümleri sunuyoruz.', tall: true },
    ...
    { section: 'hizmet-sergi-aciklama', label: 'Hizmetlerimiz — Sergi & Portfolyo Baskıları Kart Açıklaması', placeholder: 'Sergiler, portfolyolar ve projeleriniz için büyük format baskı ve profesyonel sunum çözümleri sağlıyoruz.', tall: true },
    { section: 'hizmet-cerceve-baslik', label: 'Hizmetlerimiz — Çerçeveleme Kart Başlığı', placeholder: 'Çerçeveleme' },
    { section: 'hizmet-cerceve-aciklama', label: 'Hizmetlerimiz — Çerçeveleme Kart Açıklaması', placeholder: 'Eserlerinizi tamamlayan estetik ve koruyucu çerçeve çözümlerini, farklı ölçü ve tarz seçenekleriyle sunarak baskılarımızı sergilemeye hazır hale getiriyoruz.', tall: true },
