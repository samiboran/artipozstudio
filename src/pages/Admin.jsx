...
const IMAGE_SLOTS = [
  ...
  { page: 'gallery', section: 'hizmet-film-yikama', label: 'Ana Sayfa — Hizmetlerimiz: Film Yıkama & Tarama', multiple: false, aspect: '4 / 3', defaultImg: filmYikamaHeroDefault },
...
const PAGE_TEXT_FIELDS = {
  gallery: [
    ...
    { section: 'hizmet-film-yikama-baslik', label: 'Hizmetlerimiz — Film Yıkama & Tarama Kart Başlığı', placeholder: 'Film Yıkama & Tarama' },
    { section: 'hizmet-film-yikama-aciklama', label: 'Hizmetlerimiz — Film Yıkama & Tarama Kart Açıklaması', placeholder: 'Analog filmlerinizi özenle yıkıyor, karelerinizi yüksek çözünürlüklü taramalarla dijitale aktarıyoruz.', tall: true },
